...
# Module constants
ECONOMIC_CONSTANTS = {"DAYS_PER_YEAR": Decimal("365"), "BUSINESS_DAYS_PER_YEAR": Decimal("252"), "MONTHS_PER_YEAR": Decimal("12"), "QUARTERS_PER_YEAR": Decimal("4"), "BASIS_POINTS": Decimal("10000"), "PERCENTAGE": Decimal("100")}

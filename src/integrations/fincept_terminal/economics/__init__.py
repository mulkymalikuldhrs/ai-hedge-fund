...
from .core import EconomicsBase, DataValidator, EconomicsError, ValidationError, CalculationError, DataError

from .currency_analysis import CurrencyAnalyzer, SpotForwardAnalyzer, ArbitrageDetector, ParityAnalyzer, CarryTradeAnalyzer

from .exchange_calculations import ExchangeCalculator, CrossRateCalculator, ForwardCalculator

from .growth_analysis import GrowthAnalyzer, ProductivityAnalyzer, ConvergenceAnalyzer, DemographicAnalyzer

from .market_cycles import BusinessCycleAnalyzer, MarketStructureAnalyzer, CreditCycleAnalyzer

from .policy_analysis import FiscalPolicyAnalyzer, MonetaryPolicyAnalyzer, CentralBankAnalyzer

from .trade_geopolitics import TradeAnalyzer, GeopoliticalRiskAnalyzer, TradingBlocAnalyzer

from .capital_flows import CapitalFlowAnalyzer, FXMarketAnalyzer, ExchangeRegimeAnalyzer

from .data_handler import DataHandler, DataProvider, ManualDataInput

from .analytics_engine import StatisticalAnalyzer, ForecastingEngine, ScenarioAnalyzer

from .reporting import ReportGenerator, VisualizationEngine, ExportManager

from .config import EconomicsConfig, DataSources, CalculationPrecision
...
DEFAULT_CONFIG = {"precision": 8, "base_currency": "USD", "data_validation": True, "error_tolerance": 1e-6, "default_forecast_periods": 12, "confidence_interval": 0.95}
...
def get_version_info():
    ...
    return {"version": __version__, "author": __author__, "email": __email__, "description": "CFA-based Economics Analysis Module for FinceptTerminal", "modules": len(__all__), "cfa_compliance": "Level I & II"}

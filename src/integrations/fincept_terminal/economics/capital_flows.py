...
class CapitalFlowAnalyzer(EconomicsBase):
    ...
    def analyze_capital_flow_types(self, flow_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "foreign_direct_investment": {
                ...
                "characteristics": ["Long-term commitment and stability", "Technology and knowledge transfer", "Management expertise and best practices", "Difficult to reverse quickly"],
                "economic_impact": {"positive": "Productivity gains, employment creation, export growth", "negative": "Potential crowding out of domestic investment", "volatility": "Low - stable funding source"},
            ...
            "portfolio_investment": {
                ...
                "characteristics": ["Liquid and easily reversible", "Driven by return differentials and risk appetite", "Sensitive to market sentiment", "Includes equity and debt securities"],
                "economic_impact": {"positive": "Capital market development, financing access", "negative": "Volatility and sudden stops risk", "volatility": "High - subject to rapid reversals"},
            ...
            "other_investment": {
                ...
                "characteristics": ["Includes bank loans and deposits", "Trade finance and short-term credits", "Interbank and intercompany lending", "Often procyclical"],
                "economic_impact": {"positive": "Trade finance facilitation, liquidity provision", "negative": "Banking sector vulnerabilities, sudden stops", "volatility": "Medium to High - depends on banking conditions"},
            ...
            "official_flows": {
                ...
                "characteristics": ["Reserve accumulation/depletion", "Official development assistance", "Bilateral government lending", "IMF and multilateral lending"],
                "economic_impact": {"positive": "Crisis support, development financing", "negative": "May create moral hazard", "volatility": "Low to Medium - policy driven"},
    ...
    def analyze_balance_of_payments_impact(self, bop_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "current_account_impact": {
                "trade_balance": {"surplus_effect": "Creates demand for domestic currency", "deficit_effect": "Creates supply of domestic currency", "elasticity_considerations": "J-curve effect in short run", "current_balance": self._assess_trade_balance_impact(bop_data)},
                "income_flows": {"investment_income": "Returns on foreign investments affect currency demand", "compensation": "Worker remittances and cross-border wages", "impact_assessment": self._assess_income_flows_impact(bop_data)},
                "transfers": {"remittances": "Significant for many developing countries", "official_transfers": "Aid and government transfers", "impact_assessment": self._assess_transfer_impact(bop_data)},
            },
            "capital_account_impact": {
                "direct_investment": {"fx_impact": "Usually strengthens recipient currency", "timing": "Gradual impact as investments are made", "sustainability": "Most stable form of capital flow"},
                "portfolio_investment": {"fx_impact": "Can cause rapid currency movements", "timing": "Immediate impact on exchange rates", "volatility": "High sensitivity to sentiment changes"},
                "financial_derivatives": {"fx_impact": "Complex, depends on underlying positions", "hedging_flows": "May offset other capital flows"},
                "reserve_changes": {"intervention_impact": "Central bank buying/selling affects rates", "signaling_effect": "Indicates policy stance and credibility"},
            },
    ...
    def assess_capital_restrictions(self, restriction_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "restriction_types": {
                "inflow_controls": {
                    "objectives": ["Prevent asset bubbles from hot money", "Maintain monetary policy independence", "Reduce financial stability risks", "Prevent real exchange rate appreciation"],
                    "instruments": ["Unremunerated reserve requirements", "Taxes on foreign investment", "Minimum holding periods", "Limits on foreign ownership"],
                    "effectiveness": self._assess_inflow_control_effectiveness(restriction_data),
                },
                "outflow_controls": {
                    "objectives": ["Prevent capital flight during crises", "Preserve foreign exchange reserves", "Maintain exchange rate stability", "Support domestic financing needs"],
                    "instruments": ["Approval requirements for foreign investment", "Limits on foreign currency holdings", "Restrictions on overseas deposits", "Export surrender requirements"],
                    "effectiveness": self._assess_outflow_control_effectiveness(restriction_data),
                },
            },
            "common_objectives": {"macroeconomic_stability": "Maintain stable exchange rates and inflation", "financial_stability": "Prevent excessive risk-taking and bubbles", "monetary_independence": "Preserve domestic monetary policy effectiveness", "development_goals": "Channel capital toward productive investments", "crisis_prevention": "Reduce vulnerability to sudden stops"},
            "effectiveness_factors": {"comprehensiveness": "Controls must cover all relevant channels", "enforceability": "Administrative capacity and compliance monitoring", "market_development": "May hinder financial market development", "evasion_potential": "Sophisticated investors can often circumvent controls", "international_coordination": "Effectiveness increases with coordination"},
    ...
    def _analyze_flow_determinants(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        ...
        return {
            "push_factors": ["Global risk appetite and liquidity conditions", "Advanced economy interest rates", "Global growth and commodity prices", "Investor risk tolerance"],
            "pull_factors": ["Domestic economic fundamentals", "Interest rate differentials", "Exchange rate expectations", "Political and institutional quality", "Market development and accessibility"],
            "structural_factors": ["Trade openness and integration", "Financial market development", "Capital account openness", "Institutional quality and governance"],
        }
    ...
    def _analyze_restriction_costs_benefits(self) -> Dict[str, Dict[str, List[str]]]:
        ...
        return {
            "benefits": {"macroeconomic": ["Exchange rate stability", "Monetary policy independence", "Reduced volatility"], "financial": ["Reduced systemic risk", "Prevented asset bubbles", "Banking stability"], "developmental": ["Capital allocated to development priorities", "Reduced inequality"]},
            "costs": {"efficiency": ["Reduced capital allocation efficiency", "Higher cost of capital", "Innovation constraints"], "market_development": ["Slower financial market development", "Reduced competition", "Limited diversification"], "administrative": ["High enforcement costs", "Bureaucratic burden", "Corruption risks"]},
        }
...
class FXMarketAnalyzer(EconomicsBase):
    ...
    def analyze_fx_market_structure(self, market_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "market_functions": {
                "price_discovery": {"description": "Determining exchange rates through supply and demand", "mechanism": "Continuous trading by global participants", "efficiency": "Generally efficient due to high liquidity and participation", "factors": ["Economic fundamentals", "Market sentiment", "Technical factors"]},
                "risk_management": {"description": "Hedging currency exposure for businesses and investors", "instruments": ["Spot transactions", "Forward contracts", "Options", "Swaps"], "participants": "Multinational corporations, banks, institutional investors", "importance": "Critical for international trade and investment"},
                "speculation": {"description": "Profit-seeking from currency movements", "participants": "Hedge funds, proprietary traders, retail investors", "impact": "Provides liquidity but can increase volatility", "regulation": "Subject to various regulatory constraints"},
                "arbitrage": {"description": "Exploiting price differences across markets", "types": ["Spatial arbitrage", "Triangular arbitrage", "Covered interest arbitrage"], "function": "Ensures price consistency across markets", "technology_role": "High-frequency trading dominates arbitrage"},
            },
    ...
    def distinguish_nominal_real_rates(self, rate_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "nominal_exchange_rate": {
                ...
                "characteristics": ["Directly observable in markets", "Used for actual transactions", "Affected by monetary policy and market sentiment", "Can be quoted as direct or indirect"],
            ...
            "real_exchange_rate": {
                ...
                "characteristics": ["Measures relative purchasing power", "Indicates competitiveness", "Not directly tradeable", "Important for trade flows"],
                "calculation": self._calculate_real_exchange_rate(rate_data),
                "interpretation": self._interpret_real_rate_changes(rate_data),
            },
            "relationship_analysis": {"short_run": "Nominal and real rates can diverge significantly", "long_run": "Tend to move together due to purchasing power parity", "policy_implications": "Real rates matter more for trade competitiveness", "investment_relevance": "Both rates important for different investment decisions"},
    ...
    def calculate_currency_percentage_change(self, change_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "calculation_details": {"initial_rate": initial_rate, "final_rate": final_rate, "absolute_change": final_rate - initial_rate, "percentage_change": percentage_change, "quote_convention": quote_convention},
            "currency_movement": {"summary": movement, "detailed_description": description, "direction": "appreciation" if percentage_change > 0 else "depreciation", "magnitude": self._assess_change_magnitude(abs(percentage_change))},
            "economic_implications": self._analyze_currency_change_implications(percentage_change, base_currency, quote_currency),
    ...
    def _analyze_market_participants(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "commercial_banks": {"role": "Market makers and dealers", "market_share": "~75% of daily volume", "functions": ["Provide liquidity", "Client transactions", "Proprietary trading"], "importance": "Core of interbank market"},
            "central_banks": {"role": "Policy implementation and intervention", "market_share": "~5% of daily volume", "functions": ["Monetary policy", "Reserve management", "Market intervention"], "impact": "Significant influence despite small volume"},
            "institutional_investors": {"role": "Hedging and investment", "market_share": "~10% of daily volume", "participants": ["Pension funds", "Mutual funds", "Insurance companies"], "motivation": "Risk management and portfolio optimization"},
            "hedge_funds": {"role": "Speculation and arbitrage", "market_share": "~5% of daily volume", "strategies": ["Carry trades", "Momentum", "Mean reversion"], "impact": "High influence on short-term volatility"},
            "corporations": {"role": "Commercial hedging", "market_share": "~3% of daily volume", "needs": ["Trade settlement", "Risk hedging", "Cash management"], "patterns": "Often predictable timing"},
            "retail_traders": {"role": "Small-scale speculation", "market_share": "~2% of daily volume", "access": "Through brokers and online platforms", "characteristics": "High leverage, short-term focus"},
        }
    ...
    def _analyze_trading_mechanisms(self) -> Dict[str, Any]:
        ...
        return {
            "spot_market": {"definition": "Immediate delivery (T+2 settlement)", "characteristics": "Highest liquidity, benchmark for other rates", "participants": "All market participants", "pricing": "Continuous price discovery"},
            "forward_market": {"definition": "Future delivery at predetermined rate", "characteristics": "Customizable terms, no upfront payment", "participants": "Banks, corporations, institutional investors", "pricing": "Based on interest rate differentials"},
            "futures_market": {"definition": "Standardized forward contracts on exchanges", "characteristics": "Margin requirements, daily mark-to-market", "participants": "Speculators, hedgers, arbitrageurs", "pricing": "Exchange-determined, transparent"},
            "options_market": {"definition": "Right but not obligation to exchange currencies", "characteristics": "Premium payment, asymmetric payoff", "participants": "Sophisticated institutional investors", "pricing": "Based on volatility and time value"},
            "swap_market": {"definition": "Combination of spot and forward transactions", "characteristics": "Manages liquidity without FX risk", "participants": "Central banks, commercial banks", "pricing": "Interest rate differential based"},
        }

    def _analyze_market_liquidity(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze FX market liquidity"""
        return {
            "liquidity_measures": {"bid_ask_spreads": data.get("avg_spread_bps", "1-3 basis points for major pairs"), "market_depth": "High depth due to large participant base", "resilience": "Quick recovery from temporary imbalances", "immediacy": "Instant execution for standard sizes"},
            "liquidity_hierarchy": {"tier_1": "EUR/USD, USD/JPY, GBP/USD (most liquid)", "tier_2": "USD/CHF, AUD/USD, USD/CAD", "tier_3": "Cross rates between major currencies", "tier_4": "Emerging market currencies (lower liquidity)"},
            "factors_affecting_liquidity": ["Time of day (overlap of major centers)", "Economic news and events", "Market volatility and uncertainty", "Regulatory changes", "Central bank interventions"],
            "liquidity_risk": {"normal_times": "Minimal liquidity risk for major pairs", "stress_periods": "Can experience temporary liquidity shortages", "emerging_markets": "Higher liquidity risk, especially during crises"},
        }
...
class ExchangeRegimeAnalyzer(EconomicsBase):
    ...
    def analyze_exchange_rate_regimes(self, regime_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "fixed_exchange_rate": {
                ...
                "characteristics": ["Minimal exchange rate volatility", "Requires central bank intervention", "Limited monetary policy independence", "Vulnerable to speculative attacks"],
                "advantages": ["Reduces transaction costs for trade", "Provides nominal anchor for inflation", "Reduces exchange rate uncertainty", "Facilitates international investment"],
                "disadvantages": ["Loss of monetary policy independence", "Requires large foreign exchange reserves", "Vulnerable to balance of payments crises", "May lead to real exchange rate misalignment"],
            ...
            "floating_exchange_rate": {
                ...
                "characteristics": ["High exchange rate volatility", "Automatic adjustment mechanism", "Full monetary policy independence", "Requires developed financial markets"],
                "advantages": ["Monetary policy independence", "Automatic adjustment to shocks", "No need for large reserves", "Reduces moral hazard in lending"],
                "disadvantages": ["Exchange rate volatility and uncertainty", "May complicate international trade", "Potential for destabilizing speculation", "Pass-through to domestic prices"],
            ...
            "managed_float": {
                ...
                "characteristics": ["Moderate exchange rate volatility", "Discretionary intervention", "Some monetary policy independence", "Requires judgment on intervention timing"],
                "advantages": ["Balances flexibility and stability", "Allows gradual adjustment", "Retains some policy independence", "Can prevent excessive volatility"],
                "disadvantages": ["Uncertainty about intervention policy", "May delay necessary adjustments", "Requires significant expertise", "Potential for policy mistakes"],
            ...
            "currency_union": {
                ...
                "characteristics": ["No exchange rate within union", "Common monetary policy", "Requires fiscal coordination", "Irreversible commitment"],
                "advantages": ["Eliminates exchange rate risk within union", "Reduces transaction costs", "Promotes trade and investment", "Provides credible commitment"],
                "disadvantages": ["Loss of national monetary policy", "Asymmetric shock vulnerability", "Requires fiscal transfers or flexibility", "Difficult exit mechanism"],
    ...
    def _assess_fixed_regime_sustainability(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "foreign_reserves": {"level": data.get("reserves_months_imports", "N/A"), "adequacy": "Should cover 3-6 months of imports", "assessment": self._assess_reserve_adequacy(data.get("reserves_months_imports", 3))},
            "fiscal_position": {"deficit": data.get("fiscal_deficit_gdp", "N/A"), "debt": data.get("government_debt_gdp", "N/A"), "sustainability": "Fiscal discipline critical for credibility"},
            "current_account": {"balance": data.get("current_account_gdp", "N/A"), "sustainability": "Large deficits threaten sustainability"},
            "political_commitment": {"importance": "Strong political will essential", "indicators": ["Central bank independence", "Policy consistency", "Reform commitment"]},
        }
    ...
    def _assess_floating_regime_effectiveness(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "financial_market_development": {"depth": data.get("financial_market_depth_index", "N/A"), "importance": "Deep markets reduce volatility", "requirements": ["Large participant base", "Diverse instruments", "Good regulation"]},
            "institutional_quality": {"central_bank_credibility": data.get("cb_credibility_index", "N/A"), "importance": "Credible monetary policy anchors expectations", "factors": ["Independence", "Transparency", "Track record"]},
            "pass_through_management": {"inflation_targeting": "Helps manage pass-through effects", "communication": "Clear policy communication important", "credibility": "Credible commitment to low inflation"},
        }
    ...
    def _assess_oca_criteria(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "labor_mobility": {"assessment": data.get("labor_mobility_index", "Low"), "importance": "High mobility helps adjustment to asymmetric shocks", "barriers": ["Language differences", "Cultural factors", "Regulatory barriers"]},
            "trade_integration": {"level": data.get("intra_union_trade_share", "N/A"), "importance": "High trade integration reduces asymmetric shocks", "measurement": "Share of trade within currency union"},
            "business_cycle_synchronization": {"correlation": data.get("business_cycle_correlation", "N/A"), "importance": "Synchronized cycles reduce need for independent policy", "factors": ["Similar economic structures", "Common shocks", "Policy coordination"]},
            "fiscal_transfers": {"mechanism": data.get("fiscal_transfer_mechanism", "Limited"), "importance": "Transfers help adjustment to asymmetric shocks", "examples": ["Federal systems", "EU structural funds", "Automatic stabilizers"]},
            "price_wage_flexibility": {"level": data.get("price_wage_flexibility_index", "N/A"), "importance": "Flexibility substitutes for exchange rate adjustment", "barriers": ["Labor market rigidities", "Price stickiness", "Regulatory constraints"]},
        }

    def _analyze_regime_choice_factors(self) -> Dict[str, List[str]]:
        """Analyze factors influencing exchange rate regime choice"""
        return {
            "economic_factors": ["Size and openness of economy", "Trade pattern and partner concentration", "Financial market development", "Inflation history and credibility", "Fiscal position and discipline"],
            "institutional_factors": ["Central bank independence and credibility", "Political stability and consensus", "Administrative capacity", "Legal and regulatory framework", "International integration"],
            "external_factors": ["International capital mobility", "Regional integration arrangements", "Major trading partner regimes", "Global financial conditions", "International monetary system"],
        }
    ...
    def _analyze_regime_effects_on_flows(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "trade_effects": {
                "fixed_regime": {"trade_volume": "Generally higher due to reduced uncertainty", "trade_composition": "May favor short-term over long-term contracts", "price_competitiveness": "May lead to misalignment over time"},
                "floating_regime": {"trade_volume": "May be lower due to exchange rate risk", "trade_composition": "Encourages hedging and risk management", "price_competitiveness": "Maintains competitiveness through adjustment"},
            },
            "capital_flow_effects": {
                "fixed_regime": {"portfolio_flows": "May attract flows but vulnerable to sudden stops", "fdi_flows": "Reduced exchange rate risk may encourage FDI", "speculative_flows": "Vulnerable to one-way bets against the peg"},
                "floating_regime": {"portfolio_flows": "More volatile but self-correcting", "fdi_flows": "Exchange rate risk may deter some investment", "speculative_flows": "Two-way risk reduces speculative pressure"},
            },
            "crisis_vulnerability": {"fixed_regime": "High vulnerability to balance of payments crises", "floating_regime": "Lower crisis probability but higher volatility", "managed_float": "Intermediate vulnerability depending on credibility"},
        }
